...
var bashreadlineExample = `Demonstrations of bashreadline, the Linux bpftrace/eBPF version.
...
var biolatencyExample = `Demonstrations of biolatency, the Linux BPF/bpftrace version.
...
var biosnoopExample = `Demonstrations of biosnoop, the Linux BPF/bpftrace version.
...
var biostacksExample = `Demonstrations of biostacks, the Linux BCC/eBPF version.
...
var bitesizeExample = `Demonstrations of bitesize, the Linux bpftrace/eBPF version.
...
var capableExample = `Demonstrations of capable, the Linux bpftrace/eBPF version.
...
var cpuwalkExample = `Demonstrations of cpuwalk, the Linux bpftrace/eBPF version.
...
var dcsnoopExample = `Demonstrations of dcsnoop, the Linux bpftrace/eBPF version.
...
var execsnoopExample = `Demonstrations of execsnoop, the Linux BPF/bpftrace version.
...
var gethostlatencyExample = `Demonstrations of gethostlatency, the Linux bpftrace/eBPF version.
...
var killsnoopExample = `Demonstrations of killsnoop, the Linux bpftrace/eBPF version.
...
var loadsExample = `Demonstrations of loads, the Linux bpftrace/eBPF version.
...
var mdflushExample = `Demonstrations of mdflush, the Linux bpftrace/eBPF version.
...
var naptimeExample = `Demonstrations of naptime, the Linux bpftrace/eBPF version.
...
var oomkillExample = `Demonstrations of oomkill, the Linux bpftrace/eBPF version.
...
var opensnoopExample = `Demonstrations of opensnoop, the Linux bpftrace/eBPF version.
...
var pidpersecExample = `Demonstrations of pidpersec, the Linux bpftrace/eBPF version.
...
var runqlatExample = `Demonstrations of runqlat, the Linux BPF/bpftrace version.
...
var runqlenExample = `Demonstrations of runqlen, the Linux BPF/bpftrace version.
...
var setuidsExample = `Demonstrations of setuids, the Linux bpftrace/eBPF version.
...
var statsnoopExample = `Demonstrations of statsnoop, the Linux bpftrace/eBPF version.
...
var swapinExample = `Demonstrations of swapin, the Linux BCC/eBPF version.
...
var syncsnoopExample = `Demonstrations of syncsnoop, the Linux bpftrace/eBPF version.
...
var syscountExample = `Demonstrations of syscount, the Linux bpftrace/eBPF version.
...
var tcpacceptExample = `Demonstrations of tcpaccept, the Linux bpftrace/eBPF version.
...
var tcpconnectExample = `Demonstrations of tcpconnect, the Linux bpftrace/eBPF version.
...
var tcpdropExample = `Demonstrations of tcpdrop, the Linux bpftrace/eBPF version.
...
var tcplifeExample = `Demonstrations of tcplife, the Linux bpftrace/eBPF version.
...
var tcpretransExample = `Demonstrations of tcpretrans, the Linux bpftrace/eBPF version.
...
var tcpsynblExample = `Demonstrations of tcpsynbl, the Linux bpftrace/eBPF version.
...
var threadsnoopExample = `Demonstrations of threadsnoop, the Linux bpftrace/eBPF version.
...
var vfscountExample = `Demonstrations of vfscount, the Linux bpftrace/eBPF version.
...
var vfsstatExample = `Demonstrations of vfsstat, the Linux bpftrace/eBPF version.
...
var writebackExample = `Demonstrations of writeback, the Linux bpftrace/eBPF version.
...
var xfsdistExample = `Demonstrations of xfsdist, the Linux bpftrace/eBPF version.
